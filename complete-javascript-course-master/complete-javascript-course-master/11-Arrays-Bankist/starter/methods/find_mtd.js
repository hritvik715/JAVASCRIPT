...
//NOTE - > 1.differnce in find and filter method is filter returns the all the elements that match the conditon and find return the first element which match the condition 
